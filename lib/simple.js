...
} = (await import('@reyendymion/ww_websocket_conection')).default

export function makeWASocket(connectionOptions, options = {}) {
    /**
     * @type {import('@reyendymion/ww_websocket_conection').WASocket | import('@reyendymion/ww_websocket_conection').WALegacySocket}
     */
    ...
    let sock = Object.defineProperties(conn, {
        ...
        sendFile: {
             ...
             * @param {import('@reyendymion/ww_websocket_conection').proto.WebMessageInfo} quoted
             * @param {Boolean} ptt
            ...
            async value(jid, path, filename = '', caption = '', quoted, ptt = false, options = {}) {
                ...
                /**
                 * @type {import('@reyendymion/ww_websocket_conection').proto.WebMessageInfo}
                 */
                let m
                try {
...
END:VCARD
        ...
        cMod: {
             ...
             * cMod
             * @param {String} jid 
             * @param {import('@reyendymion/ww_websocket_conection').proto.WebMessageInfo} message 
             * @param {String} text 
             * @param {String} sender 
             * @param {*} options 
             * @returns 
        ...
        loadMessage: {
             ...
             * @returns {import('@reyendymion/ww_websocket_conection').proto.WebMessageInfo}
             */
            value(messageID) {
        ...
        processMessageStubType: {
             ...
             * @param {import('@reyendymion/ww_websocket_conection').proto.WebMessageInfo} m 
             */
            async value(m) {
                ...
                for (const message of m) {
                    try {
                        ...
                        if (message.message?.[mtype]?.contextInfo?.quotedMessage) {
                            /**
                             * @type {import('@reyendymion/ww_websocket_conection').proto.IContextInfo}
                             */
                            let context = message.message[mtype].contextInfo
                            let participant = conn.decodeJid(context.participant)
                            const remoteJid = conn.decodeJid(context.remoteJid || participant)
                            /**
                             * @type {import('@reyendymion/ww_websocket_conection').proto.IMessage}
                             * 
                             */
