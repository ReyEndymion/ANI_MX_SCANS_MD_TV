 ...
 */
const { initAuthCreds, BufferJSON, proto } = (await import('@reyendymion/ww_websocket_conection')).default

/**
 * @param {import('@reyendymion/ww_websocket_conection').WASocket | import('@reyendymion/ww_websocket_conection').WALegacySocket}
 */
function bind(conn) {
    if (!conn.chats) conn.chats = {}
    /**
     * 
     * @param {import('@reyendymion/ww_websocket_conection').Contact[]|{contacts:import('@reyendymion/ww_websocket_conection').Contact[]}} contacts 
     * @returns 
     */
